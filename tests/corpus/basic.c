...
int main29()
{
    ...
    if (sizeof(static_ar6) / sizeof(struct {
                                    int x, y;
                                    }
                                    ) != 2
...
int main50()
{
    ...
    if (sizeof(primes) / sizeof(primes[0]) != 5) {
        return 1;
    }
    if (primes[0] != 2) {
        return 2;
...
int main79()
{
    ...
    return f(5, NULL, (struct main79_s)
             {
             2
             }
             , NULL, NULL, NULL, (struct main79_s)
             {
             3
             }
             ) - 10;
...
void foo89(void)
{}
static void take_ptr89(const void *p)
{
    (void)p;
}
int main89()
